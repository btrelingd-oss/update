  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      ...
      <div className="flex items-center justify-between gap-4">
        <nav className="flex items-center gap-2 text-xs font-medium text-slate-500 overflow-x-auto whitespace-nowrap">
          <button
            ...
            className="hover:text-rose-600 font-semibold transition-colors flex items-center gap-1.5 cursor-pointer"
          ...
          <span className="text-slate-300">/</span>
          <span className="text-slate-900 font-bold flex items-center gap-1.5 bg-rose-50 text-rose-700 px-2.5 py-0.5 rounded-md">
            <span>{creator.name}</span>
            <span className="text-[10px] font-extrabold uppercase tracking-wider bg-rose-600 text-white px-1.5 py-0.2 rounded-xs">
              Portfolio
            </span>
          </span>
        </nav>
        ...
        <button
          ...
          type="button"
          onClick={onNavigateToMarketplace}
          className="text-xs font-bold text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-100 border border-slate-200 px-3 py-1.5 rounded-xl transition-all flex items-center gap-1.5 shadow-2xs cursor-pointer shrink-0"
        >
          <Home className="w-3.5 h-3.5 text-rose-500" />
      ...
      <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-xs">
        ...
        <div className="h-44 sm:h-56 bg-gradient-to-r from-slate-900 via-rose-950 to-slate-900 relative overflow-hidden flex items-end p-6">
          ...
          <div className="absolute top-4 right-4 flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white text-xs font-bold rounded-xl border border-white/20 transition-all flex items-center gap-1.5 cursor-pointer"
        ...
        <div className="px-6 sm:px-8 pb-8 pt-0 relative">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 -mt-16 sm:-mt-20 mb-6 pb-6 border-b border-slate-100">
            {/* Avatar & Identifiers */}
                ...
                <div className="flex items-center gap-2" id="portfolio-header-social-icons">
                  {instagramHref && (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-pink-50 hover:bg-pink-100 text-pink-600 hover:text-pink-700 border border-pink-200/80 shadow-2xs flex items-center justify-center transition-all hover:scale-105 active:scale-95 cursor-pointer group"
                    >
                  ...
                  {twitterHref && (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-600 hover:text-sky-700 border border-sky-200/80 shadow-2xs flex items-center justify-center transition-all hover:scale-105 active:scale-95 cursor-pointer group"
                    >
                  ...
                  {websiteHref && (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-600 hover:text-indigo-700 border border-indigo-200/80 shadow-2xs flex items-center justify-center transition-all hover:scale-105 active:scale-95 cursor-pointer group"
                    >
          ...
          {/* Quick Metrics Bar */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 text-center mb-6">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-2">
            ...
            <div className="md:col-span-4 space-y-2">
              ...
              {(instagramHref || twitterHref || websiteHref || behanceHref || youtubeHref) ? (
                <>
                  <div className="flex items-center gap-2 p-2.5 bg-slate-50/90 border border-slate-100 rounded-2xl mb-2.5">
                    ...
                    {instagramHref && (
                      <a
                        ...
                        className="w-9 h-9 rounded-xl bg-pink-50 hover:bg-pink-100 text-pink-600 hover:text-pink-700 border border-pink-200/70 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-2xs cursor-pointer"
                      >
                    ...
                    {twitterHref && (
                      <a
                        ...
                        className="w-9 h-9 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-600 hover:text-sky-700 border border-sky-200/70 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-2xs cursor-pointer"
                      >
                    ...
                    {websiteHref && (
                      <a
                        ...
                        className="w-9 h-9 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-600 hover:text-indigo-700 border border-indigo-200/70 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-2xs cursor-pointer"
                      >
                    ...
                    {behanceHref && (
                      <a
                        ...
                        className="w-9 h-9 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-700 border border-blue-200/70 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-2xs cursor-pointer"
                      >
                    ...
                    {youtubeHref && (
                      <a
                        ...
                        className="w-9 h-9 rounded-xl bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 border border-red-200/70 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-2xs cursor-pointer"
                      >
                  ...
                  <div className="flex flex-col gap-2">
                    {instagramHref && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between p-2.5 rounded-xl bg-pink-50/60 hover:bg-pink-100/70 text-pink-700 border border-pink-100 text-xs font-semibold transition-all group"
                      >
                    ...
                    {twitterHref && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between p-2.5 rounded-xl bg-sky-50/60 hover:bg-sky-100/70 text-sky-700 border border-sky-100 text-xs font-semibold transition-all group"
                      >
                        <div className="flex items-center gap-2">
                          <Twitter className="w-4 h-4" />
                          <span>X (Twitter)</span>
                    ...
                    {websiteHref && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between p-2.5 rounded-xl bg-indigo-50/60 hover:bg-indigo-100/70 text-indigo-700 border border-indigo-100 text-xs font-semibold transition-all group"
                      >
                        <div className="flex items-center gap-2">
                          <Globe className="w-4 h-4" />
                    ...
                    {behanceHref && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between p-2.5 rounded-xl bg-blue-50/60 hover:bg-blue-100/70 text-blue-700 border border-blue-100 text-xs font-semibold transition-all group"
                      >
                        <div className="flex items-center gap-2">
                          <Palette className="w-4 h-4" />
                    ...
                    {youtubeHref && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between p-2.5 rounded-xl bg-red-50/60 hover:bg-red-100/70 text-red-700 border border-red-100 text-xs font-semibold transition-all group"
                      >
                        <div className="flex items-center gap-2">
                          <Youtube className="w-4 h-4" />
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-center">
                  <p className="text-xs text-slate-400">No social media profiles added yet.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-1.5 text-xs bg-white border border-slate-200 rounded-xl focus:border-rose-500 focus:outline-hidden w-48 sm:w-56"
              />
            </div>
            ...
            <select
              ...
              className="px-3 py-1.5 text-xs bg-white border border-slate-200 rounded-xl font-semibold text-slate-700 focus:outline-hidden cursor-pointer"
            >
              <option value="popular">Most Popular</option>
              <option value="newest">Newest Releases</option>
              <option value="title">Artwork Title (A-Z)</option>
            </select>
          </div>
        </div>
                  ...
                  <div className="p-5 border-t border-slate-100 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center justify-between text-[11px] text-slate-400 mb-1">
                        ...
                        <span className="font-semibold text-emerald-600">+{art.creatorMarginPercent}% royalty</span>
                      </div>
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
                      ...
                      <span className="text-xs font-bold text-rose-600 group-hover:bg-rose-600 group-hover:text-white bg-rose-50 px-3 py-1.5 rounded-xl transition-colors flex items-center gap-1">
