  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <nav
        ...
        className="flex items-center gap-1.5 sm:gap-2 text-xs font-medium text-slate-500 mb-6 overflow-x-auto whitespace-nowrap py-1"
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl hover:bg-slate-100 text-slate-700 hover:text-rose-600 transition-all font-semibold cursor-pointer group"
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl hover:bg-indigo-50 text-slate-700 hover:text-indigo-600 transition-all font-semibold cursor-pointer group"
          title="Explore Art & Design artworks"
        >
          <Palette className="w-3.5 h-3.5 text-indigo-500 group-hover:scale-110 transition-transform" />
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold transition-all cursor-pointer border border-slate-200 shadow-2xs"
          ...
          >
            ...
            <ChevronDown className={`w-3.5 h-3.5 text-slate-500 transition-transform ${showProductSwitcher ? 'rotate-180' : ''}`} />
          </button>

          {showProductSwitcher && (
            <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-slate-200 rounded-2xl shadow-xl p-2 z-50 animate-in fade-in-50 zoom-in-95">
              <div className="px-3 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider border-b border-slate-100 flex items-center justify-between">
                ...
                <span className="text-rose-600 font-bold">{PRODUCT_CATALOG.length} Formats</span>
              </div>
              ...
              <div className="border-t border-slate-100 mt-1 pt-1.5">
                <button
                  ...
                  className="w-full text-center px-3 py-2 rounded-xl text-xs font-bold text-white bg-slate-900 hover:bg-black transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs"
                >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200/80 font-black transition-all cursor-pointer shadow-2xs group"
          title={`Click to view full original "${artwork.title}" artwork graphic & details`}
        >
          <Sparkles className="w-3.5 h-3.5 text-rose-600 group-hover:scale-125 transition-transform" />
          <span className="truncate max-w-[140px] sm:max-w-none">{artwork.title}</span>
          <span className="text-[10px] bg-rose-600 text-white px-1.5 py-0.2 rounded-full font-bold ml-0.5">
            Art Details
          </span>
        </button>
      </nav>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="relative bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-xs">
            {/* View Mode Switcher Header */}
            <div className="absolute top-4 right-4 z-20 flex items-center gap-1.5 bg-white/90 backdrop-blur-xs p-1 rounded-xl border border-slate-200 shadow-xs">
              <button
            ...
            <div className="bg-slate-50 border-t border-slate-100 px-6 py-3 flex items-center justify-between text-xs text-slate-600">
          ...
          <div id="also-available-products" className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs scroll-mt-24">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
              <div>
                ...
                <span className="text-xs text-slate-500">Click to switch mockup preview, or add the complete collection</span>
              </div>
              ...
              <button
                ...
                className="self-start sm:self-auto px-3.5 py-1.5 rounded-xl bg-slate-900 hover:bg-black text-white text-xs font-bold transition-all flex items-center gap-2 shadow-xs cursor-pointer active:scale-95 group"
              >
                <Layers className="w-3.5 h-3.5 text-rose-400 group-hover:rotate-12 transition-transform" />
                <span>Add to All Products</span>
                <span className="text-[10px] bg-rose-600 text-white font-black px-1.5 py-0.2 rounded-md">
                  Save 15%
                </span>
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-2.5">
              {PRODUCT_CATALOG.map((prod) => {
                ...
                return (
                  ...
                  >
                    <div className="w-14 h-14 rounded-xl overflow-hidden flex items-center justify-center bg-slate-100 mb-1.5 relative">
                      <MockupRenderer
                        productType={prod.category}
                        color={prod.colors[0]}
                        artworkUrl={artwork.imageUrl}
                    ...
                    <span className="text-[11px] font-semibold text-slate-900 line-clamp-1 leading-tight">
                    ...
                    <button
                      ...
                      className="w-full py-1 text-[10px] font-bold text-rose-700 bg-rose-50 hover:bg-rose-600 hover:text-white rounded-lg transition-colors flex items-center justify-center gap-1"
                    >
                      <span>+ Add</span>
                    </button>
                  </div>
          ...
          <div id="artist-spotlight" className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xs space-y-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-5 border-b border-slate-100">
              ...
              >
                <img
                  ...
                  className="w-16 h-16 rounded-2xl object-cover border-2 border-rose-100 shadow-xs group-hover/artist:border-rose-400 transition-colors"
                />
                <div>
                  <div className="flex items-center gap-1.5">
                    <h4 className="text-base sm:text-lg font-black text-slate-900 group-hover/artist:text-rose-600 group-hover/artist:underline transition-colors flex items-center gap-1.5">
                      <span>{creator?.name || artwork.creatorName}</span>
                      <ExternalLink className="w-3.5 h-3.5 text-rose-500 opacity-60 group-hover/artist:opacity-100 transition-opacity" />
                    </h4>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5 flex items-center gap-1.5">
                    ...
                    <span>{(creator?.totalSales || 1420).toLocaleString()} artworks sold</span>
                  </p>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 transition-all cursor-pointer shadow-2xs"
            ...
            <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(creator.instagram || creator.socialLinks?.instagram) && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-pink-50 text-pink-700 border border-pink-100 text-xs font-semibold hover:bg-pink-100 transition-colors"
                    ...
                    {(creator.twitter || creator.socialLinks?.twitter) && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-sky-50 text-sky-700 border border-sky-100 text-xs font-semibold hover:bg-sky-100 transition-colors"
                    ...
                    {creator.socialLinks.website && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-50 text-indigo-700 border border-indigo-100 text-xs font-semibold hover:bg-indigo-100 transition-colors"
                    ...
                    {creator.socialLinks.youtube && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-50 text-red-700 border border-red-100 text-xs font-semibold hover:bg-red-100 transition-colors"
                    ...
                    {creator.socialLinks.tiktok && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 text-slate-800 border border-slate-200 text-xs font-semibold hover:bg-slate-200 transition-colors"
                        title="TikTok"
                      >
                    ...
                    {creator.socialLinks.behance && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-50 text-blue-700 border border-blue-100 text-xs font-semibold hover:bg-blue-100 transition-colors"
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 text-xs text-slate-600">
                <span className="font-bold text-slate-800 block mb-0.5">Design Inspiration for this Artwork:</span>
                {artwork.description}
              </div>
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {artwork.tags.map((tag) => (
                  <button
                    ...
                    className="px-2.5 py-1 bg-slate-100 text-slate-600 hover:bg-rose-50 hover:text-rose-700 text-xs font-medium rounded-lg cursor-pointer transition-colors"
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-slate-100">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm font-bold text-slate-900">{averageRating} out of 5</span>
                  <span className="text-xs text-slate-400">• Verified Purchases</span>
                </div>
              </div>

              <button
                onClick={() => setShowReviewModal(true)}
                className="px-4 py-2 border border-slate-300 hover:border-slate-400 rounded-xl text-xs font-semibold text-slate-800 transition-colors"
              >
                Write a Review
              </button>
            </div>
            ...
            <div className="space-y-4">
              {filteredReviews.map((rev) => (
                <div
                  key={rev.id}
                  className="p-4 rounded-2xl bg-slate-50/70 border border-slate-100"
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      {rev.verifiedBuyer && (
                        <span className="text-[10px] text-emerald-700 bg-emerald-100 px-1.5 py-0.2 rounded-xs font-medium">
                          Verified Buyer
                        </span>
                      )}
                    </div>
        ...
        <div className="lg:col-span-5">
          <div className="sticky top-28 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-6">
            {/* Title & Artist Byline */}
            <div>
              <div className="flex items-center justify-between gap-2 mb-1.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full border border-slate-200 text-slate-400 hover:text-slate-700 transition-colors"
                    title="Share artwork"
                  >
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-xs sm:text-sm text-slate-500">
                  ...
                  <button
                    ...
                    className="font-bold text-slate-900 underline decoration-rose-400 underline-offset-2 hover:text-rose-600 transition-colors inline-flex items-center gap-1 cursor-pointer"
            ...
            <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80">
              <div className="flex items-baseline justify-between">
                <div>
                  <span className="text-3xl font-black text-slate-900">{formatPrice(unitPrice)}</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs font-bold text-slate-900 uppercase tracking-wide">
                  Color: <span className="text-slate-600 normal-case">{selectedColor.name}</span>
                </label>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs font-bold text-slate-900 uppercase tracking-wide">
                  Size: <span className="text-slate-600 normal-case">{selectedSize}</span>
                </label>
                <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center border border-slate-200 rounded-xl overflow-hidden bg-white">
                <button
                  ...
                  className="px-3 py-1.5 text-sm font-bold text-slate-600 hover:bg-slate-100 transition-colors"
                >
                  -
                </button>
            ...
            <div className="space-y-2.5 pt-2">
              <button
                id="add-to-cart-btn"
                onClick={handleAdd}
                className="w-full py-3.5 px-6 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 active:scale-[0.99]"
              >
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl bg-slate-900 hover:bg-black text-white font-bold text-sm shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <div className="pt-2 border-t border-slate-100">
                <button
                  ...
                  type="button"
                  onClick={() => setShowAllProductsModal(true)}
                  className="w-full py-3 px-3.5 rounded-2xl bg-gradient-to-r from-rose-50 via-amber-50 to-orange-50 hover:from-rose-100 hover:to-orange-100 border border-rose-200 text-slate-900 font-bold text-xs transition-all flex items-center justify-between group shadow-2xs cursor-pointer"
                >
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-xl bg-rose-600 text-white flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform shrink-0">
                      <Layers className="w-4 h-4" />
                    </div>
                    <div className="text-left">
                      <div className="flex items-center gap-1.5">
                        <span className="font-extrabold text-slate-900">Add to All Products</span>
                        <span className="bg-rose-600 text-white text-[10px] font-black px-1.5 py-0.2 rounded-md uppercase">
                          Bundle
                        </span>
                      </div>
                  ...
                  <div className="flex items-center gap-1 text-rose-600 font-bold text-xs group-hover:translate-x-0.5 transition-transform shrink-0">
                    <span>Bundle</span>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100 text-xs text-slate-600">
              <div className="flex items-center gap-3">
                ...
                <span>
                  Worldwide shipping • Ships within <strong>24–48 hours</strong>
                </span>
              </div>
              <div className="flex items-center gap-3">
                <RotateCcw className="w-4 h-4 text-slate-700 shrink-0" />
                <span>
                  Free return or exchange guarantee within <strong>30 days</strong>
                </span>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="bg-slate-50 rounded-2xl p-4 text-xs text-slate-600 space-y-2">
              <p className="font-bold text-slate-900">{currentProductConfig.displayName} Details:</p>
      ...
      {showSizeGuide && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl animate-in zoom-in-95">
              ...
              <table className="w-full text-xs text-left">
                ...
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  ...
                  <tr className="bg-rose-50/60 font-semibold text-rose-900">
                    <td className="py-2 font-bold">M (Popular)</td>
                    <td>20.0"</td>
                    <td>29.0"</td>
                    <td>8.5"</td>
                  </tr>
            ...
            <button
              onClick={() => setShowSizeGuide(false)}
              className="w-full py-2.5 bg-slate-900 hover:bg-black text-white text-xs font-bold rounded-xl"
            >
              Close Size Chart
            </button>
          </div>
      ...
      {showReviewModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <form
            ...
            className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl animate-in zoom-in-95 space-y-4"
          >
              ...
              <div className="flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((num) => (
                  ...
                  >
                    <Star
                      className={`w-6 h-6 ${
                        num <= newReviewRating ? 'fill-amber-400' : 'text-slate-300'
                      }`}
                    />
                  </button>
                ))}
            ...
            <div className="flex items-center gap-2 pt-2">
              <button
                type="button"
                onClick={() => setShowReviewModal(false)}
                className="flex-1 py-2.5 border border-slate-200 text-slate-700 rounded-xl text-xs font-bold cursor-pointer"
              >
                Cancel
              </button>
              <button
      ...
      {showAllProductsModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95">
            {/* Modal Header */}
                ...
                return (
                  <div
                    ...
                    className={`pt-3.5 first:pt-0 flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-3 rounded-2xl transition-all ${
                      config.enabled
                        ? 'bg-rose-50/20 border border-rose-100/60'
                    ...
                    <div className="flex items-center gap-3.5 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-[10px] text-emerald-600 font-semibold bg-emerald-50 px-1.5 py-0.2 rounded-sm">
                      ...
                      <div className="flex items-center gap-3 pl-7 sm:pl-0">
                        ...
                        {prod.sizes.length > 1 && (
                          <select
                            ...
                            className="text-[11px] font-semibold text-slate-700 bg-white border border-slate-200 rounded-lg px-2 py-1 focus:outline-hidden focus:border-rose-500 cursor-pointer"
                          >
                            {prod.sizes.map((s) => (
            ...
            <div className="p-5 sm:p-6 bg-slate-50 border-t border-slate-100 rounded-b-3xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-[11px] font-bold text-emerald-600 bg-emerald-100/70 px-1.5 py-0.5 rounded-md">
                      Saved {formatPrice(bundleDiscountAmount)} (15% Off)
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-500 mt-0.5">
                    Includes <strong>+{formatPrice(bundleTotalArtistMargin)}</strong> direct artist earnings for {artwork.creatorName}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 disabled:opacity-50 text-white text-xs font-black rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer active:scale-95"
                  >
      ...
      {showArtworkDetailModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-slate-200 shadow-2xl p-6 relative animate-in zoom-in-95">
            <button
              type="button"
            ...
            <p className="text-xs text-slate-500 mb-5">
              By independent artist <strong className="text-slate-800">{creator?.name || artwork.creatorName}</strong>
            </p>

            <div className="aspect-square max-h-80 w-full bg-slate-50 rounded-2xl border border-slate-100 p-6 flex items-center justify-center overflow-hidden mb-6 shadow-inner">
              <img
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {artwork.tags.map((tag) => (
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-600 text-xs font-medium rounded-lg cursor-pointer transition-colors"
                    >
                      #{tag}
                    </button>
                  ))}
              ...
              <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 bg-slate-900 hover:bg-black text-white text-xs font-bold rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                >
                  <Layers className="w-3.5 h-3.5 text-rose-400" />
                ...
                <button
                  type="button"
                  onClick={() => setShowArtworkDetailModal(false)}
                  className="w-full sm:w-auto px-4 py-2.5 bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold rounded-xl cursor-pointer text-center"
                >
